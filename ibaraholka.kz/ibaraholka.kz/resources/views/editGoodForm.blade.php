    ...
    <div class="container bg-light p-t-35 p-b-80">
        ...
        <div class="flex-w flex-sb">
            ...
            <div class="w-size14 p-t-30 respon5">
                    ...
                    <a href="#" class="title product-detail-name m-text16 p-b-13" data-type="text" data-column="title" data-url="{{route('editTitle')}}" data-pk="{{$good->id}}" data-title="title" data-name="title"> {{$good->title}} <i class="glyphicon glyphicon-pencil"></i></a>
                   </h4>
